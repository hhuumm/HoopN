...
async function getPlaces(req,res)
{
    ...
    if(req.params.lat)
    {
     ...
     await axios.get(`https://maps.googleapis.com/maps/api/place/nearbysearch/json?key=${process.env.GOOGLE_KEY}&location=${lat},${lng}&radius=12000&type=park&name=basketball`)
